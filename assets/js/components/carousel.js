...
class Carousel {
    ...
    setPositionByIndex() {
      ...
      nextItem.style.transform = `translate(-50%, calc(-50% + 30px)) scale(0.9)`;
      nextItem2.style.transform = `translate(-50%, calc(-50% + 45px)) scale(0.9)`;
      nextItem3.style.transform = `translate(-50%, calc(-50% + 60px)) scale(0.9)`;
      nextItem4.style.transform = `translate(-50%, calc(-50% + 75px)) scale(0.9)`;
